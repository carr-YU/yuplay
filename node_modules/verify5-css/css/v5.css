...
.v5-icon-1{ background:url(../images/icon-button-normal.png) no-repeat center center; }
.v5-icon-2{ background:url(../images/icon-button-arrow.png) no-repeat center center; }
...
.v5-icon-close{ background:url(../images/icon-close.png) no-repeat; background-size:100%; }
.v5-icon-refresh{ background:url(../images/icon-refresh.png) no-repeat; background-size:100%; }
.v5-icon-feedback{ background:url(../images/icon-help.png) no-repeat;background-size:100%;  }
...
.v5-logo-small{ display:inline-block; width:22px;height:22px; background:url(../images/logo-small.png) no-repeat; background-size:100%;  position:absolute; left:50%;top:50%;margin:-11px 0 0 -11px; z-index:2; opacity:.4;transition:.5s;  }
...
.v5-icon-ok{ display:block; width: 18px;height: 18px; background:url(../images/icon-ok.png) no-repeat center center ; vertical-align:top; background-size:100%; position:absolute; z-index:1;top:3px;left:6px;}
.v5-ok-move {
    position: absolute;
    z-index:2;
    width: 22px;
